      ...
      <div className="grid grid-cols-10 gap-4 items-center">
        ...
        <div className="col-span-4">
          <input
            ...
            onChange={(e) => setNPM(e.target.value)} // Mengatur state untuk NPM
          />
        </div>
        ...
        <div className="col-start-2 col-span-4">
          <button
            className="btn btn-success mr-5 w-28"onClick={setSaveData}>Simpan</button>
          <Link href={"/"} className="btn btn-warning ml-5 w-28">Batal</Link>
        </div>
      </div>
</>
);
